...
class FractalCreator(object):
    ...
    @cuda.jit
    def mandel_kernel(self, min_x, max_x, min_y, max_y, image, iters):
        ...
        for x in range(startX, width, gridX):
            ...
            for y in range(startY, height, gridY):
                ...
                image[y, x] = self.mandel_gpu(real, imag, iters)

    def generate_img(self, centerX=-0.5, centerY=0, zoom=1, res=1080, iters=20, aspect=3 / 2):
        ...
        self.mandel_kernel[griddim, blockdim](centerX - dx, centerX + dx, centerY - dy, centerY + dy, d_image, iters)
        d_image.to_host()
